...
You can find a more detailed description at http://www.castle104.com/ponzu
...
Ponzu-based Rails app. For details, take a look at the ponzu_demo
app (the one that is live at http://ponzu-demo.castle104.com ) source
code. The root commit is a freshly started Rails project 
(<code>rails new ponzu_demo</code>). View the commit history to
see what additions were made.

We plan to create appropriate generator scripts to aid installation
in the future.
