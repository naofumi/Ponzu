...
class ConferencesControllerTest < ActionController::TestCase
  ...
  #     post :create, conference: { dates: @conference.dates, module_name: @conference.module_name, support_email: @conference.support_email }
  #   end
  ...
  #   put :update, id: @conference, conference: { dates: @conference.dates, module_name: @conference.module_name, support_email: @conference.support_email }
  #   assert_redirected_to conference_path(assigns(:conference))
  # end
